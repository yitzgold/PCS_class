<?php
    ...
    try {
        ...
        $seforim = $db->query('SELECT name FROM sefer_price')->fetchAll(PDO::FETCH_COLUMN);
        $options = "";
        foreach ($seforim as $sefer) {
            $options .= "<option value=$sefer> $sefer </option>";
        }
...
<body>
    <div class="container">
        ...
        <form class="form-horizontal" action="seferReturn_62.php" method="get">
